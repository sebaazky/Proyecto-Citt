...
class Track(models.Model):
    ...
    descripcion = models.CharField(max_length=250, default='Descripción del track')
    imagen = models.ImageField(upload_to='images/',default='images/default_track.png')
...
class ReunionTrack(models.Model):
    ...
    id_docente = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, db_column='idDocente')
    track = models.ForeignKey(Track, on_delete=models.CASCADE, related_name='reuniones')
    fecha = models.DateField()
    hora = models.TimeField()
    modalidad = models.CharField(max_length=20, choices=[('presencial', 'Presencial'), ('virtual', 'Virtual')], default='presencial')
    link_virtual = models.URLField(blank=True, null=True, help_text="Enlace para reuniones virtuales")
